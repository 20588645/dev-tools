...
![Version](https://img.shields.io/badge/version-0.1.91-green)
...
- **本地日志解析** — 直接解析 `~/.claude/projects` 会话日志统计 Claude Code 模型用量，按 message.id 去重，文件级增量扫描
...
# src-tauri/target/release/bundle/dmg/DevTools_0.1.91_aarch64.dmg
```
