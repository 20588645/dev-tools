...
| 15 | Phase 8 | Vue 应用壳与 Router | **已完成（P8-1～P8-6）** | 用户 Tauri 冒烟 → Phase 9 | 见 `pages/shell/` |
| 16 | Phase 9 | 旧架构清理与发布 | 等待冒烟 / 可启动 | 删除 legacy bridge、旧 `src` 和污染 CSS | G7/G8、正式构建、升级与全量回归通过 |
